...
/**
 * Emulation of the Pro Action Replay device.
 * This device allows to apply "RAM codes" to have extra lives, ammo, time, etc...
 * 
...
public class ActionReplay
{
    ...
    /**
     * Creates a new Pro Action Replay device which will act on the given memory.
     * @param cpuram - memory
     */
    ...
    /**
     * Add a memory patch.
     * The patch is permanent (the value is constantly written into memory until a new game is loaded).
     */
    ...
    /**
     * Find where in RAM can be found the given value.
     * This method begins a new search.
    ...
    /**
     * Find where at the previously found addresses can be found the given value.
     * This method continue a previously started search.
     * @param value - value to be found.
     * @return the list of addresses where the value were found.
     */
